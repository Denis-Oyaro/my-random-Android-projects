...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        // Find fields to populate in inflated layout
        TextView name_text = (TextView) view.findViewById(R.id.name);
        TextView summary_text = (TextView) view.findViewById(R.id.summary);
        ...
        name_text.setText(petName);
        if(TextUtils.isEmpty(petBreed)){
            summary_text.setText("Unknown breed");
        } else {
            summary_text.setText(petBreed);
        }
    }
}
