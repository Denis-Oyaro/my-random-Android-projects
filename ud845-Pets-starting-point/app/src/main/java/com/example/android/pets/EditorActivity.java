...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(petUri != null) {
            setTitle("Edit Pet");
            Log.v("EditorActivity",petUri.toString());
    ...
    private void savePet() {
        ...
        //all fields left blank when adding new pet
        if(petUri == null && TextUtils.isEmpty(petName) && TextUtils.isEmpty(petBreed) &&
                TextUtils.isEmpty(petWeightString) && mGender == PetEntry.GENDER_UNKNOWN){
            return;
        }
        ...
        if(petUri == null) {
            ...
            if (rowsUpdated != 1) {
                Toast.makeText(this, R.string.pet_not_edited, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, R.string.pet_edited, Toast.LENGTH_SHORT).show();
            }
        }
    }
